...
import saladImage from './ImageComp/salad_image1.jpg';
  ...
  return (
    <div className="main-layout">
      ...
      <div className="meal-plan-recipes">
        <div className="featured-mealplan">
          <Link to="/mealplan-1" style={{ textDecoration: 'none' }}>
            <img src={saladImage} alt="Featured Salad" />
          </Link>
          <p className="featured-mealplan-title">FEATURED SALAD RECIPE:</p>
        ...
        <div className="meal-plan-content">
          <div className="mealplan-breadcrumb">
            <Link to="/home" className="mealplan-breadcrumb-link">FITNESSFEAST</Link> &gt; <Link to="/recipes" className="mealplan-breadcrumb-link">RECIPES</Link> &gt; SALADS
          </div>
          <h2>Salad Recipes</h2>
          <p>Explore a variety of vibrant salad recipes that elevate your meal prep routine to new heights. Our selection ensures you spend just a few hours prepping, granting you a week of fresh, delicious meals. Indulge in the freedom to focus on the myriad other aspects of your busy life.</p>
        </div>
      </div>

      <div className="top-rated-recipes-container">  
        <h2 className="top-rated-recipes-header">
          <i className="fas fa-trophy"></i> TOP RATED SALADS
        </h2>
        <p className="top-rated-recipes-description">Out of all the many salads on Fitness Feast, these are our shining stars - the<br />recipes we come back to again and again (and again).</p>
      ...
      <div className="top-rated-recipes-container">  
        ...
        <p className="top-rated-recipes-description">Explore our diverse collection of nutritious salads—the ultimate go-to<br />for wholesome, delicious and satisfying meals.</p>
