    ...
    <div className="main-layout">
      ...
      <div className="meal-plan-recipes">
        <div className="featured-mealplan">
          <Link to="/recipeone" style={{ textDecoration: 'none' }}>
            <img src={bowlImage} alt="Featured Bowl" />
          </Link>
          <p className="featured-mealplan-title">FEATURED BOWL RECIPE:</p>
          <p className="featured-mealplan-name"><Link to="/recipeone" style={{ textDecoration: 'none' }}>7-DAY LOW-SODIUM MEAL PLAN</Link></p>
        </div>
        <div className="meal-plan-content">
          <div className="mealplan-breadcrumb">
            <Link to="/home" className="mealplan-breadcrumb-link">FITNESSFEAST</Link>  &gt; <Link to="/recipes" className="mealplan-breadcrumb-link">RECIPES</Link> &gt; BOWLS
          </div>
          <h2>Bowl Recipes</h2>
          <p>Bowl recipes are your secret weapon for simplifying healthy meal planning, effortlessly banishing the stress of daily cooking. Spend just a few hours prepping and enjoy a week of nourishing meals, freeing your mind to focus on all your wellness goals.</p>
        </div>
      </div>

      <div className="top-rated-recipes-container">  
        <h2 className="top-rated-recipes-header">
          <i className="fas fa-trophy"></i> TOP RATED BOWLS
        </h2>
        <p className="top-rated-recipes-description">Out of all the many bowls on Fitness Feast, these are our shining stars - the<br />recipes we come back to again and again (and again).</p>
      ...
      <div className="top-rated-recipes-container">  
        ...
        <p className="top-rated-recipes-description">Explore our diverse collection of nutritious bowls—the ultimate go-to<br />for wholesome, delicious and satisfying meals.</p>
