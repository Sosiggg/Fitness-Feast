...
import './PawpawSalad.css';
import { Link } from 'react-router-dom';
import foodImage3 from './ImageComp/pawpawsalad.jpg';
      ...
      <div className="recipe-container">
        <div className="recipe-content">
          <div className="CBP-photo-container">
            <img src={foodImage3} alt="Herby Summer Tart" className="pasta-photo" />
          ...
          <div className="dish-name-paw">Nutrient-packed Pawpaw Salad</div>
