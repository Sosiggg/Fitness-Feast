...
import './HerbySummerTart.css';
import { Link } from 'react-router-dom';
import PastaDish from './ImageComp/tartdish.jpg';
      ...
      <div className="recipe-container">
        <div className="recipe-content">
          <div className="CBP-photo-container">
            <img src={PastaDish} alt="Herby Summer Tart" className="pasta-photo" />
          ...
          <div className="dish-name-herby">Herby Tart with Summer Tomatoes</div>
...
export default HerbySummerTart;
