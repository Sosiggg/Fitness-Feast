  ...
  return (
    <div className="main-layout">
      ...
      <div className="meal-plan-recipes">
        <div className="featured-mealplan">
          <Link to="/mealplan-1" style={{ textDecoration: 'none' }}>
            <img src={soupsImage} alt="Featured Soup" />
          </Link>
          <p className="featured-mealplan-title">FEATURED SOUP:</p>
        ...
        <div className="meal-plan-content">
          <div className="mealplan-breadcrumb">
            <Link to="/home" className="mealplan-breadcrumb-link">FITNESSFEAST</Link>  &gt; <Link to="/recipes" className="mealplan-breadcrumb-link">RECIPES</Link> &gt; SOUPS
          </div>
          <h2>Soup Recipes</h2>
          <p>Soup Recipes gets big love from us because it’s so great to not even have to THINK about what to cook every day. Spend a few hours getting everything prepped and then the rest of your week is made! Now your brain space can be filled with, well...all the other stuff.</p>
        </div>
      </div>

      <div className="top-rated-recipes-container">  
        <h2 className="top-rated-recipes-header">
          <i className="fas fa-trophy"></i> TOP RATED SOUPS
        </h2>
      ...
      <div className="top-rated-recipes-container">  
        ...
        <p className="top-rated-recipes-description">Explore our diverse collection of nutritious soups—the ultimate go-to<br />for wholesome, delicious and satisfying meals.</p>
